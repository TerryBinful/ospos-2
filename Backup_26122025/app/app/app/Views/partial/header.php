...
<head>
    <meta charset="utf-8">
    <base href="<?= base_url() ?>">
    <title><?= esc($config['company']) . ' | ' . lang('Common.powered_by') . ' FlipStudios ' ?></title>
    <link rel="shortcut icon" type="image/x-icon" href="images/cherish/cherish-removebg-preview.ico">
	...
	<link rel="stylesheet" href="css/login.css">        <link rel="stylesheet" href="resources/css/register-a6a6cc948d.css">
        ...
        <div class="navbar navbar-default" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand hidden-sm" href="<?= site_url() ?>">Cherish 🍾</a>
                </div>
