...
return [
    ...
    "software_short"                 => "CHERISH",
    "software_title"                 => "Point of Sale",
    "state"                          => "State",
    "submit"                         => "Submit",
    "total_spent"                    => "Total Spent",
    "unknown"                        => "Unknown",
    "view_recent_sales"              => "View Recent Sales",
    "website"                        => "opensourceposguide.com/guide",
    "welcome"                        => "Welcome",
    "welcome_message"                => "Welcome to CHERISH ENT., click a module below to get started.",
    "yes"                            => "Yes",
    "you_are_using_ospos"            => "",
    "zip"                            => "Postal Code",
];
